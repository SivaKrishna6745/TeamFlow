...
const DelConfirmationPopup = ({ onConfirm, onCancel }: { onConfirm: () => void; onCancel: () => void }) => {
    return (
        <>
            ...
            <div className="fixed top-1/2 left-1/2 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center gap-8 rounded-lg z-50 p-8 bg-zinc-900 shadow-2xl">
                ...
                <div className="flex gap-4 items-center justify-end">
                    ...
                    <Button
                        label="Confirm"
                        className="w-full sm:w-auto px-5 py-2 text-sm font-medium text-white bg-red-600 rounded-sm shadow-sm shadow-red-900/20 transition-all hover:bg-red-500 hover:shadow-red-500/20 active:scale-98"
                        onClick={onConfirm}
                    />
                </div>
            </div>
